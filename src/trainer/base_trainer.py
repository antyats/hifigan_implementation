...
class BaseTrainer:
    ...
    def __init__(
        ...
        Args:
            ...
            gen_loss (nn.Module): loss function for model training.
    ...
    def _clip_grad_norm(self):
        ...
        if self.config["trainer"].get("max_grad_norm", None) is not None:
            ...
            clip_grad_norm_(
                self.disc.parameters(), self.config["trainer"]["max_grad_norm"]
            )
    ...
    def _save_checkpoint(self, epoch, save_best=False, only_best=False):
        ...
        state = {
            "arch": arch,
            "epoch": epoch,
            "model_gen_state_dict": self.model.state_dict(),
            "model_disc_state_dict": self.disc.state_dict(),
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        self.model.load_state_dict(checkpoint["model_gen_state_dict"])
        self.disc.load_state_dict(checkpoint["model_disc_state_dict"])
        ...
        if (
            ...
            self.disc_lr_scheduler.load_state_dict(
                checkpoint["disc_lr_scheduler"]
            )
